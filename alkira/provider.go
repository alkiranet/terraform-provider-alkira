...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"alkira_peering_gateway_azure_vnet_third_party_connector_attachment": resourceAlkiraPeeringGatewayAzureVnetThirdPartyConnectorAttachment(),
			...
			"alkira_probe_http":                                                  resourceAlkiraProbeHTTP(),
			"alkira_probe_https":                                                 resourceAlkiraProbeHTTPS(),
			"alkira_probe_tcp":                                                   resourceAlkiraProbeTCP(),
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"alkira_connector_prisma_sdwan":             dataSourceAlkiraConnectorPrismaSDWAN(),
			...
			"alkira_peering_gateway_azure_vnet_third_party_connector_attachment": dataSourceAlkiraPeeringGatewayAzureVnetThirdPartyConnectorAttachment(),
