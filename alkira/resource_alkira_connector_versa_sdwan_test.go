...
func TestVersaSdwanAllowListSchema(t *testing.T) {
	resourceSchema := resourceAlkiraConnectorVersaSdwan().Schema
...
func TestVersaSdwanAllowListValidator(t *testing.T) {
	validate := resourceAlkiraConnectorVersaSdwan().Schema["allow_list"].Elem.(*schema.Schema).ValidateFunc
...
func TestVersaSdwanAllowListExpand(t *testing.T) {
