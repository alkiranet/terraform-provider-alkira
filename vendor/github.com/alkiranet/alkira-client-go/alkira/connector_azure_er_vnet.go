...
type ConnectorAzureErVnetSegment struct {
	...
	SegmentId             json.Number `json:"segmentId:omitempty"`
...
type ConnectorAzureErVnet struct {
	...
	Cxp            string                         `json:"cxp"`
	Instance       []ConnectorAzureErVnetInstance `json:"instances"`
	SegmentOptions []ConnectorAzureErVnetSegment  `json:"segmentOptions"`
