...
**Edit rules for `docs/`** (verified empirically against tfplugindocs v0.19.4):

- `docs/resources/`, `docs/data-sources/`, `docs/index.md` — auto-generated. Never edit; edit the schema or `templates/` instead.
- `docs/guides/` — auto-generated from `templates/guides/`. Edit the template, not the doc.
- `docs/changes/` — hand-edited per-release changelog. Preserved by `make doc`. See [Per-release Changelog](#per-release-changelog) below.
- Any other custom subfolder under `docs/` — preserved by `make doc`.
...
4. Generates markdown files in `docs/resources/`, `docs/data-sources/`, and `docs/guides/`
5. Creates/updates `docs/index.md` for the provider

**Note for worktrees:** the working directory's basename becomes the rendered provider name in every `page_title`. If you're inside a worktree (basename != `terraform-provider-alkira`), run `tfplugindocs generate --provider-name terraform-provider-alkira` directly instead of `make doc`, otherwise every doc file's page title gets silently rewritten.

### Per-release Changelog

`docs/changes/` holds one markdown file per release. PRs that change user-visible behavior append entries to `docs/changes/unreleased.md`. When a release is cut, that file is renamed to `vX.Y.Z.md` and a fresh `unreleased.md` is created for the next cycle. The release notes are assembled from these files.

See `docs/changes/README.md` for full rules and entry format.
...
6. **Update the changelog**: If your PR changes resource behavior, schema, or state semantics — anything user-visible — append an entry to `docs/changes/unreleased.md`. Cover what shipped and the user impact. See `docs/changes/README.md`.
7. **Commit all changes**: Include generated documentation in your commit
...
- A `docs/changes/unreleased.md` entry when behavior or schema changes
...
│   ├── changes/            # Per-release changelog (manual; one file per version)
│   ├── data-sources/       # Auto-generated by tfplugindocs (DO NOT EDIT)
│   ├── guides/             # Auto-generated from templates/guides/ (edit the template, not the doc)
│   ├── resources/          # Auto-generated by tfplugindocs (DO NOT EDIT)
│   └── index.md            # Auto-generated by tfplugindocs (DO NOT EDIT)
