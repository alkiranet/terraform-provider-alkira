...
- `tunnel` (Block List) Tunnel of the gateway. (see [below for nested schema](#nestedblock--gateway--tunnel))
...
- `advanced_options` (Block List) Advanced options for the IPSec gateway. (see [below for nested schema](#nestedblock--gateway--tunnel--advanced_options))
- `profile_id` (Number) The profile ID of the tunnel.

Read-Only:

- `id` (Number) The ID of the tunnel.
