...
### Nested Schema for `segment_scale_options.additional_tunnel_options_per_node`

Required:

- `id` (Number) The ID of the tunnel option.
- `label` (String) The label for the tunnel option.

Optional:

- `enabled` (Boolean) Whether this tunnel is enabled.
